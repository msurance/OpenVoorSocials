...
class SocialPost(models.Model):
    ...
    # Boost / ad campaign fields
    boost_status = models.CharField(max_length=20, blank=True, default='')
    boost_campaign_id = models.CharField(max_length=64, blank=True, default='')
    boost_ad_set_id = models.CharField(max_length=64, blank=True, default='')
    boost_ad_id = models.CharField(max_length=64, blank=True, default='')
    boost_daily_budget_eur = models.DecimalField(max_digits=6, decimal_places=2, null=True, blank=True)
    boost_end_date = models.DateField(null=True, blank=True)
    boost_reach = models.IntegerField(null=True, blank=True)
    boost_spend_eur = models.DecimalField(max_digits=8, decimal_places=2, null=True, blank=True)
